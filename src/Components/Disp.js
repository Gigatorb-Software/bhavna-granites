...
const Disp=()=>{ 
        return (
        <> 
        <section className="inner-page-banner bg-common inner-page-margin  Contitle" data-bg-image="img/figure/banner.jpg">
        ...
        <section classNameName="contact-page-wrap">
                <div classNameName="contact-method-area">
                    <div classNameName="row">
                        <div classNameName="col-md-3 col-sm-6">
                            <div classNameName="contact-list">
                                <h5 classNameName="item-title">Address:</h5>
                                <ul>
                        ...
                        <div classNameName="col-md-3 col-sm-6">
                            <div classNameName="contact-list">
                                <h5 classNameName="item-title">Phone:</h5>
                                <ul>
                        ...
                        <div classNameName="col-md-3 col-sm-6">
                            <div classNameName="contact-list">
                                <h5 classNameName="item-title">E-mail:</h5>
                                <ul>
                        ...
                        <div classNameName="col-md-3 col-sm-6">
                            <div classNameName="contact-list">
                                <h5 classNameName="item-title">Fax:</h5>
                                <ul>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div classNameName="col-md-6">
                            <div className="footer-box-layout1">
                            <h3 classNameName="footer-title">Useful Links</h3>
        ...
        <p><img src={logo3} alt="logo" className="img-fluid logo"></img>     WebSite Designed by Gigatorb Software Pvt. Ltd.</p>
        </section>
        </>);
};
